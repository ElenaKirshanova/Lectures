...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
	...
	%Straight Lines [id:da17602726868869878] 
	\draw    (144.5,127.83) -- (252,127.51) ;
	\draw [shift={(255,127.5)}, rotate = 179.83] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (5.36,-2.57) -- (0,0) -- (5.36,2.57) -- cycle    ;
	%Straight Lines [id:da5151276494097119] 
	\draw    (404.5,127.82) -- (512,127.5) ;
	\draw [shift={(401.5,127.83)}, rotate = 359.83] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (5.36,-2.57) -- (0,0) -- (5.36,2.57) -- cycle    ;
	%Straight Lines [id:da09168079881977365] 
	\draw    (401.5,165.33) -- (509,165.01) ;
	\draw [shift={(512,165)}, rotate = 179.83] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (5.36,-2.57) -- (0,0) -- (5.36,2.57) -- cycle    ;
	%Straight Lines [id:da606368011362501] 
	\draw    (147.5,165.32) -- (255,165) ;
	\draw [shift={(144.5,165.33)}, rotate = 359.83] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (5.36,-2.57) -- (0,0) -- (5.36,2.57) -- cycle    ;
	%Straight Lines [id:da4782643167070846] 
	\draw    (401.5,195.83) -- (509,195.51) ;
	\draw [shift={(512,195.5)}, rotate = 179.83] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (5.36,-2.57) -- (0,0) -- (5.36,2.57) -- cycle    ;
	%Straight Lines [id:da0586486120331462] 
	\draw    (144.5,195.83) -- (252,195.51) ;
	\draw [shift={(255,195.5)}, rotate = 179.83] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (5.36,-2.57) -- (0,0) -- (5.36,2.57) -- cycle    ;
	
	% Text Node
	\draw (259,34) node [anchor=north west][inner sep=0.75pt]   [align=left] {\structure{\boxed{P \in E(\mathbb{F}_q)}}};
	% Text Node
	\draw (442,108) node [anchor=north west][inner sep=0.75pt]   [align=left] {\structure{$[b] P$}};
	% Text Node
	\draw (103,115) node [anchor=north west][inner sep=0.75pt]   [align=left] {\structure{$a \in N$}};
	% Text Node
	\draw (186,100) node [anchor=north west][inner sep=0.75pt]   [align=left] {\structure{$[a] P$}};
	% Text Node
	\draw (311.5,73) node [anchor=north west][inner sep=0.75pt]   [align=left] {\includegraphics[width=2.5em]{mouse.png}};
	% Text Node
	\draw (524,118) node [anchor=north west][inner sep=0.75pt]   [align=left] {\structure{$b \in N$}};
	% Text Node
	\draw (447,146) node [anchor=north west][inner sep=0.75pt]   [align=left] {\structure{$[c] P$}};
	% Text Node
	\draw (24,151) node [anchor=north west][inner sep=0.75pt]   [align=left] {key\_a = [a] ([c] P)};
	% Text Node
	\draw (191,138) node [anchor=north west][inner sep=0.75pt]   [align=left] {$[c] P$};
	% Text Node
	\draw (315,146) node [anchor=north west][inner sep=0.75pt]   [align=left] {$c \in \mathbb{N}$};
	% Text Node
	\draw (524,159) node [anchor=north west][inner sep=0.75pt]   [align=left] {Ключ: [b] ([c] P)};
	% Text Node
	\draw (1,188) node [anchor=north west][inner sep=0.75pt]   [align=left] {c1=Enc\_key(cheese)};
	% Text Node
	\draw (251,176) node [anchor=north west][inner sep=0.75pt]   [align=left] {cheese = Dec\_key\_a(c1)};
	% Text Node
	\draw (251,198) node [anchor=north west][inner sep=0.75pt]   [align=left] {c2 = $Enc_{key_b}(cheese)$};
	% Text Node
	\draw (173,176) node [anchor=north west][inner sep=0.75pt]   [align=left] {c1};
	% Text Node
	\draw (450,175) node [anchor=north west][inner sep=0.75pt]   [align=left] {c2};
	% Text Node
	\draw (524,189) node [anchor=north west][inner sep=0.75pt]   [align=left] {cheese = Dec\_key\_b(c2)};
	% Text Node
	\draw (104,76) node [anchor=north west][inner sep=0.75pt]   [align=left] {\structure{{\Large\faUserSecret}}};
	% Text Node
	\draw (524,72) node [anchor=north west][inner sep=0.75pt]   [align=left] {structure{{\Large\faCat}}};
\end{tikzpicture}
		\end{center}
		\begin{itemize}
