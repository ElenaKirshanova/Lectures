...
\def\R{6}
	...
	% random points
	\draw[color=white] (-1.9, 0.2)  node[circle,fill,inner sep=2.0pt, label={\huge $x_1$}]{};
	\draw[color=white] (-3.9, 2.2)  node[circle,fill,inner sep=2.0pt, label={\huge $x_2$}]{};
	\draw[color=white] (1.9, 1.2)  node[circle,fill,inner sep=2.0pt, label={\huge $x_3$}]{};
	\draw[color=white] (2.9, -0.6)  node[circle,fill,inner sep=2.0pt, label={\huge $x_4$}]{};
	\draw[color=white] (2.2, 3.2)  node[circle,fill,inner sep=2.0pt, label={\huge $x_5$}]{};
	\draw[color=white] (-1.9, -1.2)  node[circle,fill,inner sep=2.0pt, label={\huge $x_6$}]{};
	
	\draw[color=white] (-4.9, 5.2)  node[circle,fill,inner sep=2.0pt, label={\huge $x_7$}]{};
	\draw[color=white] (-5.9, 1.7)  node[circle,fill,inner sep=2.0pt, label={\huge $x_8$}]{};
	\draw[color=white] (-6.0, 4.2)  node[circle,fill,inner sep=2.0pt, label={\huge $x_9$}]{};
	\draw[color=white] (-2.6, 3.2)  node[circle,fill,inner sep=2.0pt, label={\huge $x_{10}$}]{};
	\draw[color=white] (-0.9, -3.2)  node[circle,fill,inner sep=2.0pt, label={\huge $x_{11}$}]{};
