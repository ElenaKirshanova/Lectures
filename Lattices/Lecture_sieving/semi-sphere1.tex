...
\draw[-stealth, color=white, thick, densely dashed] (0,0,0) -- (-1,2.5,2.2) node[midway, xshift=-10pt]{};
\draw[-stealth, color=white, thick, densely dashed] (0,0,0) -- (-1,4.2,-2.0) node[midway, yshift=-12pt]{};
%\draw[dashed, color=white, densely dashed] (-1,2.5,2.2) -- (-1,4.2,-2.0) node[midway, xshift=20pt]{};
