...
\begin{document}	
	...
	\begin{center}
		{\LARGE\textbf{
			...
			Опубликована \textbf{29.10.2020} \\[5pt] 
			Дэдлайн \textbf{12.11.2020}
...
\begin{itemize}
    \item Лабораторную следует выполнять модификацией файла с тестами (TP6\_tests.sage), заменяя строку ``\texttt{\# your code here.}'' ~на код, реализующий функцию.
    \item Функции должны работать на всех примерах, что проверяется запуском команды:
    \\\texttt{sage -t TP6\_tests.sage}\\
