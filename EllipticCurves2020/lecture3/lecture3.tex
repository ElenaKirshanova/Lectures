...
\lecture{№3 --- 24.09.20}{Осень 2020}{Лектор: Семён Новосёлов}

\begin{definition}
	\label{def_01}
	Порядок точки $P \in E$, $\operatorname{ord} P$ -- минимальное $n \in \N$ такое, что
	\[
	n \cdot P = \mathcal{O}
	\]
\end{definition}
...
\begin{definition}
	\label{def_02}
	Для $n > 1$, $E$ -- эллиптической кривая над полем $K$ точками  $n$-кручения называется множество
	$$
