...
\begin{frame}{Мотивация}
    ...
    \begin{itemize}
        \item классическая -- диcкретный логарифм (ECDH, ECDSA)
        \begin{itemize}
            \item использование: https (TLS), SSH, IPsec
        \end{itemize}
        \item постквантовая -- изогении (SIKE)
        \begin{itemize}
            \item кандидат на стандартизацию 
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{center}
    \begin{tcolorbox}[enhanced,hbox,colback=title-and-section-color!5,colframe=title-and-section-color!120,title=Теорема,center title]
        \begin{varwidth}{\textwidth}
            \begin{center}
                $E_1 \cong E_2$ над $\overline{K} \iff j(E_1)=j(E_2)$
            \end{center}
        \end{varwidth}
    \end{tcolorbox}	
\end{center}
