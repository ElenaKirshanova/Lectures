...
\begin{document}	
    {\noindent
        ...
        \begin{center}
            ...
            Опубликована \textbf{09.10.2020} \\[5pt] 
            Дэдлайн \textbf{30.10.2019}
        ...
        \begin{itemize}
            \item Лабораторную следует выполнять модификацией файла с тестами (TP4\_tests.sage), заменяя строку ``\texttt{\# your code here.}'' ~на код, реализующий функцию.
            \item Функции должны работать на всех примерах, что проверяется запуском команды:
            \\\texttt{sage -t TP4\_tests.sage}\\
