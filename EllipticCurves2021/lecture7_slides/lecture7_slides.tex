...
%Т.~е. необх. показать, что $r \mid \operatorname{ord}_{\mathbb{Z}_q^\times}(a)$ с большой вероятностью для $a \in \mathbb{Z}_N^\times$.
%Вероятность, что целое число делится на простое~$r$ равна $\frac{1}{r}$.
%Вероятность, что целое число делится на простое~$r$ равна $\frac{1}{r}$.
