...
\]
\begin{center}
$\forall P \in E$: $2 P = \mathcal{O} \Leftrightarrow $ касательная $\ell$ в $P$ -- вертикальная
\end{center}
\[\Downarrow\]
\[
y = 0
...
%\begin{table}[]
    \begin{tabular}{cc}
        ...
        $ \Downarrow $ & $ \Downarrow $ \\
        \multicolumn{2}{c}{
            $P = (x,y)$, $2 P =\mathcal{O}$ $\Rightarrow$ касательная к $P$ -- вертикаль $\Rightarrow$ $\frac{{dE}}{{dy}} = 0$
        } \\
        $ \Downarrow $ & $ \Downarrow $ \\
...
\begin{itemize}
    \item описывают отображение $n: P \mapsto n \cdot P$
