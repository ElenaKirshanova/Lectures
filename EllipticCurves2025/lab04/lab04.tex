...
\begin{document}	
    {\noindent
        ...
        Преподаватель {С. Новоселов}   \hfill{2025\\}
        \hrule
        \begin{center}
            {\LARGE\textbf{
                    Лабораторная работа № 4 \\[5pt]
            }} 
            Опубликована \textbf{17.10.2025} \\[5pt] 
            Дэдлайн \textbf{07.11.2025}
        ...
        \begin{itemize}
            \item Функция должна быть оптимизирована так, чтобы выполняться на тестах за разумное время (около 5 минут).
