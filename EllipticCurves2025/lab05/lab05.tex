...
\begin{document}	
	...
	\begin{center}
		{\LARGE\textbf{
				Лабораторная работа № 5 \\[5pt]
		}} 
			Опубликована \textbf{17.10.2025} \\[5pt] 
			Дэдлайн \textbf{14.11.2025}
	...
	\begin{enumerate}
		\item \texttt{factorECM($N$)}, где $N=p q$, $p,q$ -- простые. Функция реализует алгоритм факторизации на эллиптической кривой и возвращает либо $(p,q)$, либо, в случае длительных вычислений, ``делители не найдены''.
		
		Для тестирования можно пользоваться встроенной функцией, см. \url{http://doc.sagemath.org/html/en/reference/interfaces/sage/interfaces/ecm.html}.
