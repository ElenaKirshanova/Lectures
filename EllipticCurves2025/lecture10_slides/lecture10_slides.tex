...
\begin{itemize}
	...
	\item сложность: $\mathcal{O}(\sqrt[6]{p})$ (квант. алг.) и $\mathcal{O}(\sqrt[4]{p})$ (класс. алг.)
\end{itemize}
...
\begin{frame}{Конструктивное использование атаки}
	\begin{itemize}
	\item[\structure{{\faScroll}}] 
	Dartois P., Leroux A., Robert D., Wesolowski B.
