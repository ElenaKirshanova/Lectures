...
\hrule \vspace{5mm}
	...
	Реализовать алгоритм, решающий задачу HNP для $p$ порядка 512 бит. Для реализации оракула можете использовать скрипт~\cite{script} а для нахождения ближайшего вектора можно использовать функцию babai (реализована в fpylll, см. также \url{https://crypto-kantiana.com/elena.kirshanova/teaching/lattices_2023/babai.py} ).  Вам нужно восстановить как значение $b_i$, так и $\alpha$.
