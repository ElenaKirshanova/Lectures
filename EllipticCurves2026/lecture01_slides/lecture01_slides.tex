...
\begin{frame}{Темы курсовых}
	\begin{enumerate}
		...
		\item {\footnotesize\href{https://crypto-kantiana.com/semyon.novoselov/teaching/elliptic_curves_2026\#topics}{crypto-kantiana.com/semyon.novoselov/teaching/elliptic\_curves\_2026}}
	\end{enumerate}
\end{frame}

\begin{frame}{Дополнительно: ``Криптография на изогениях''}
	Специализированный курс по постквантовой криптографии на эллиптических кривых.
	
	\vspace{1em}
	
	\structure{Начало:} 15 октября.
	
	\vspace{1em}
	
	\structure{Преподаватели:} Новоселов С.А., Киршанова Е.А.
	...
	\begin{itemize}
		\item{\footnotesize
			\url{https://lms.kantiana.ru/course/view.php?id=27470}
		}
	\end{itemize}
\end{frame}
