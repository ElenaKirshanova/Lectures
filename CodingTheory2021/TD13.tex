...
\section{Алгоритм декодирования кода Гоппы}
		...
		\begin{questions}
 		...
 		\textit{
 		\begin{enumerate}
			\item Вычислить синдром $s(x) = \sum_{i =1}^n \frac{y_i}{x-\alpha_i}$
			\item Используя сравнение $\sigma(x) s(x) \equiv \omega(x) \bmod g(x)$, найти многочлены $\sigma(x), \omega(x)$.
		...
		\begin{equation*}
		\begin{aligned}[c]
			\frac{1}{x-\alpha_1} &\equiv x+1 \bmod g(x) \\ 
			\frac{1}{x-\alpha_2} &\equiv x \bmod g(x)   \\
			\frac{1}{x-\alpha_3} &\equiv \alpha^2x+\alpha^2+\alpha+1 \bmod g(x)  \\
			\frac{1}{x-\alpha_4} &\equiv (\alpha^2+\alpha)x+\alpha+1 \bmod g(x)  \\
		\end{aligned} \quad \quad 
		\begin{aligned}[c]
		\frac{1}{x-\alpha_5} &\equiv \alpha^2x+\alpha+1 \bmod g(x) \\
		 \frac{1}{x-\alpha_6} &\equiv \alpha x+\alpha^2+1 \bmod g(x) \\
		 \frac{1}{x-\alpha_7}& \equiv \alpha x+\alpha^2 +\alpha+1 \bmod g(x) \\
		  \frac{1}{x-\alpha_8} &\equiv (\alpha^2+\alpha)x+\alpha^2+1 \bmod g(x) \\
		\end{aligned}
		\end{equation*}
