...
\section{Обобщенный код Хэмминга}
	Покажите, что обобщенный код Хэмминга с параметрами $[2^r-1, 2^r - 1 -r, 3]$ удовлетворяет границе Гильберта-Варшамова точно (граница ГВ: $\Vol_q^{n-1}(d-2) < q^{n-k}$)
